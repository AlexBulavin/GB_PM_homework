...
### отчет об итогах выполнения проекта, а также провел бы оценку результатов проекта.
    ...
    - cust dev
    - масштабирование маркетинга и продвижения

    Итерация 5:
    - дополнение функционала ПО в соответствии с результатами cust dev
    - cust dev, обработка метрик, масштабирование продаж.
